...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo("Sample Application REST API", "The API exposes common functionallities to " + "manage the FirendsNet", "API TOS", "Terms of service", "ginxaco@gmail.com","License of API", "API license URL");
		return apiInfo;
	}
}
